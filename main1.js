var canvas,
    ...
    gameLoopInterval,
    touchInterval,
    gameAreaH = Math.round( window.innerHeight * 0.865 ),
    gameAreaW = Math.round( window.innerWidth * 0.865 ),
    scaleH = +((gameAreaH / 690).toFixed(4)),
    scaleW = +((gameAreaW / 431).toFixed(4));
...
window.onload = function(){
    ...
    canvasStatus.height = window.innerHeight;
    canvasStatus.width = window.innerWidth;
